...
DataSet整理了一些关于大模型数据集方面的事情，比如开源的数据集下载地址或者一些大模型pre-trained、SFT以及RLHF的数据处理，更多请参考[DataSet](https://github.com/ArronAI007/Awesome-AGI/tree/main/DataSet/README.md)

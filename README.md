...
| Xlang |  |  |  |
| Claude Code | Anthropic 推出的智能体编程工具，直接在终端运行，能够读取代码库、编辑文件、执行命令，并与开发工具深度集成。 |  | [Claude Code 学习笔记](https://github.com/ArronAI007/Awesome-AGI/tree/main/04-applications/agents/claude-code) |
